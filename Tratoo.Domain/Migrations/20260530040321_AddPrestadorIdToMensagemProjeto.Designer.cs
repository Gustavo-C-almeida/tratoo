...
namespace Tratoo.Domain.Migrations
{
    ...
    [Migration("20260530040321_AddPrestadorIdToMensagemProjeto")]
    partial class AddPrestadorIdToMensagemProjeto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tratoo.Domain.Models.PrestadorEmbedding", b =>
                {
                    b.Property<int>("PrestadorId")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("IndexadoEm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValueSql("GETUTCDATE()");
                    ...
                    b.Property<string>("ModeloVersao")
                        ...
                        .HasDefaultValue("all-MiniLM-L6-v2");
            ...
            modelBuilder.Entity("Tratoo.Domain.Models.ProjetoEmbedding", b =>
                {
                    b.Property<int>("ProjetoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tratoo.Domain.Models.PrestadorEmbedding", b =>
                {
                    b.HasOne("Tratoo.Domain.Models.Prestador.Prestador", "Prestador")
                        .WithOne()
                        .HasForeignKey("Tratoo.Domain.Models.PrestadorEmbedding", "PrestadorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Tratoo.Domain.Models.ProjetoEmbedding", b =>
                {
                    b.HasOne("Tratoo.Domain.Models.Projeto", "Projeto")
                        .WithOne()
                        .HasForeignKey("Tratoo.Domain.Models.ProjetoEmbedding", "ProjetoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
