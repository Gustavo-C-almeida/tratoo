...
{
    /// <inheritdoc />
    public partial class ReestruturarBanco : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataEvento = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAgentContratante = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    UserAgentPrestador = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConteudoHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TemplateVersao = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CriadoEm = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    RespostaPublica = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RespostaPublicaCriadaEm = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NotaPrazo = table.Column<byte>(type: "tinyint", nullable: true),
                    NotaComunicacao = table.Column<byte>(type: "tinyint", nullable: true),
                    NotaQualidade = table.Column<byte>(type: "tinyint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ContratoServicoId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DescricaoEntrega = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    Observacoes = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    DataEntrega = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AprovadaEm = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AprovadorId = table.Column<int>(type: "int", nullable: true),
                    MotivoRejeicao = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConviteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxaGateway = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChaveR2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
